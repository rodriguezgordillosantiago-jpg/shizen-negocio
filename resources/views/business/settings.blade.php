            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="minOrder" value="{{ old('minOrder', 15000) }}" placeholder="15000 COP">
                    </div>
                    <div class="form-group" style="margin-bottom:0">
                        <label class="form-label">Radio de domicilio (km)</label>
                        <input type="number" class="form-control" name="radius" value="{{ old('radius', 5) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="prepTime" value="{{ old('prepTime', 25) }}" min="5" max="120">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Máximo de pedidos simultáneos</label>
                        <input type="number" class="form-control" name="maxOrders" value="{{ old('maxOrders', 12) }}" min="1">
                    </div>
                </div>
            </div>
